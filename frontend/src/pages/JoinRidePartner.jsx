...
const JoinRidePartner = () => {
  const { formData, handleChange, handleSubmitRidePartner, loading, status } = useSignUp();
    ...
    >
      <div className="bg-white bg-opacity-90 p-6 sm:p-8 rounded-lg shadow-lg w-full max-w-sm sm:max-w-md">
        <h2 className="text-gray-800 text-xl sm:text-2xl font-semibold text-center">
          Welcome New Ride Partner. Please Sign Up to Continue!
        </h2>
        ...
        <button
          type="submit"
          onClick={handleSubmitRidePartner}
          disabled={loading}
...
export default JoinRidePartner;
